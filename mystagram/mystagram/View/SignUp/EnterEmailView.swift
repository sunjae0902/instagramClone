...
struct EnterEmailView: View {
    ...
    var body: some View {
        ...
        SignupBackgroundView {
            VStack {
                Text("이메일 주소 입력").font(.createFont(weight: .regular, size: 28)).fontWeight(.semibold).frame(maxWidth: .infinity, alignment: .leading).padding(.bottom, 5).padding(.horizontal)
